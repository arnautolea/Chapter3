...
public class Exercise0311 { //AccountTest
	
	 public static void main(String[] args) {
		 
	      Account0311 account1 = new Account0311("Jane Green", 50.00);
	      Account0311 account2 = new Account0311("John Blue", -7.53); 
	   ...
	   // display balances
	      ...
	      System.out.printf("%nsubtract %.2f from account1 balance%n%n", 
	         withdrawAmount);
